...
global.channelLink = "https://whatsapp.com/channel/0029Vb6bX19Ae5Vkwb2Ifa3u";
global.ytch = "@Davek254";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        // Check owner status for owner ⎋ESCANOR 
        if (isOwnerCommand) {
        ...
        // Add this near the start of your message handling logic, before processing ⎋ESCANOR 
        try {
